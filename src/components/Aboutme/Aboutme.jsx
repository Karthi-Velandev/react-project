  ...
  return (
    <div className="about-me-card">
      ...
      <div className="social-links">
        <a href="https://www.linkedin.com/in/karthi-keyan-d-703b83327/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
          {SocialIcons.linkedin}
        </a>
        <a href="https://github.com/Karthi-Velandev" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
          {SocialIcons.github}
        </a>
